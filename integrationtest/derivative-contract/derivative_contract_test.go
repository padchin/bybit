...
import (
	...
	"github.com/padchin/bybit/v2"
	"github.com/padchin/bybit/v2/integrationtest/testhelper"
...
func TestDerivativesIndexPriveKline(t *testing.T) {
	client := bybit.NewTestClient()
	res, err := client.Derivative().Contract().DerivativesIndexPriceKline(bybit.DerivativesIndexPriceKlineParam{
		Symbol:   bybit.SymbolDerivativeBTCUSDT,
		Category: bybit.CategoryDerivativeLinear,
		Interval: bybit.IntervalD,
		Start:    1652112000000,
